      ...
      <div className="bg-white p-10 rounded-3xl shadow-2xl shadow-olive-100 w-full max-w-md border border-gray-100">
        ...
        <form onSubmit={handleSignup} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-olive-600 to-olive-700 text-white py-4 rounded-xl font-bold shadow-lg shadow-olive-100 hover:shadow-olive-200 hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:translate-y-0 mt-4"
          >
